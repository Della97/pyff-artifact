...
class Sink():
    def __init__(self, num_w, latency_log_file="./results/latency/hash_proc/latency_log_hash_proc.csv"):
        self.counter = 0
...
def run_tests(worker_counts, total_inputs, output_file, use_subinterpreters=True):
    for n in worker_counts:
        ...
        with open("results/fastflow_result_times_proc_ASH.csv", "a", newline="") as timefile:
